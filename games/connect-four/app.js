...
//check the board for win or lose
  function checkBoard() {
        ...
        for(let k = 0; k < winningArrays.length; k++) {
            const square1 = squares[winningArrays[k][0]];
            const square2 = squares[winningArrays[k][1]];
            const square3 = squares[winningArrays[k][2]];
            const square4 = squares[winningArrays[k][3]];
